...
while True:
    ...
    print("")
    print("Welcome to the Geometry Dash Save File Backup Manager!")
    print("A program that automates backing your CCGameManager and CCLocalLevels up for you in a neat gdsave (zip) file.")
    print("")
    print("made by sushiwt 2024 - - - Geometry Dash belongs to RobTop Games")
